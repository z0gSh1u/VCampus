...
public class BookDetails extends JDialog {
	...
	public BookDetails(String title, String ISBN, String category, String details) {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(BookDetails.class.getResource("/resources/assets/icon/fav.png")));
		setResizable(false);
		...
		list = ResponseUtils.getResponseByHash(
				new Request(App.connectionToServer, null, "tech.zxuuu.server.library.BookServer.searchSimilarBook",
						new Object[] { title, txtCategory.getText() }).send())
