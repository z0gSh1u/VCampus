...
public class AppTeachingManager extends JFrame {
	...
	public AppTeachingManager() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(AppTeachingManager.class.getResource("/resources/assets/icon/fav.png")));
		...
		studentManageButtonGroup.setBorder(new TitledBorder(null, "\u5B66\u751F\u7BA1\u7406", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		// TODO Release this: lblCardNumber.setText(App.session.getManager().getCardNumber());
